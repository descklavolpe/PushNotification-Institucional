...
<body class="bg-theme bg-theme1">
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<div>
					<img src="/Vertical/assets/images/pushtitulo.png" class="logo-icon-2"/>
				</div>
						...
						<div class="col-12 col-lg-8">
							<div class="card radius-15">
								<div class="card-header border-bottom-0">
									<div class="d-flex align-items-center">
										<div>
											<h5 class="mb-0">Revenue By Location</h5>
										</div>
										<div class="dropdown ml-auto">
											<div class="cursor-pointer font-24 dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown"><i class="bx bx-dots-horizontal-rounded"></i>
											</div>
							...
							<div class="card radius-15">
								<div class="card-body">
									...
									<div class="media align-items-center mt-3">
										<img src="/Vertical/assets/images/avatars/avatar-1.png" width="45" height="45" class="rounded-circle" alt="">
									...
									<hr>
									<div class="media align-items-center">
										<img src="/Vertical/assets/images/avatars/avatar-2.png" width="45" height="45" class="rounded-circle" alt="">
										<div class="media-body ml-3">
									...
									<hr>
									<div class="media align-items-center">
										<img src="/Vertical/assets/images/avatars/avatar-3.png" width="45" height="45" class="rounded-circle" alt="">
										<div class="media-body ml-3">
									...
									<hr>
									<div class="media align-items-center">
										<img src="/Vertical/assets/images/avatars/avatar-4.png" width="45" height="45" class="rounded-circle" alt="">
										<div class="media-body ml-3">
								...
								<table class="table mb-0">
									...
									<tbody>
										<tr>
											<td>
												<div class="product-img bg-transparent border">
													<img src="/Vertical/assets/images/icons/smartphone.png" width="35" alt="">
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="product-img bg-transparent border">
													<img src="/Vertical/assets/images/icons/watch.png" width="35" alt="">
												</div>
											</td>
											<td>Hand Watch</td>
											<td>Milona Burke</td>
										...
										<tr>
											<td>
												<div class="product-img bg-transparent border">
													<img src="/Vertical/assets/images/icons/laptop.png" width="35" alt="">
												</div>
											</td>
											<td>Mini Laptop</td>
											<td>Craig Clayton</td>
										...
										<tr>
											<td>
												<div class="product-img bg-transparent border">
													<img src="/Vertical/assets/images/icons/shirt.png" width="35" alt="">
												</div>
											</td>
											<td>Slim-T-Shirt</td>
											<td>Clark Andola</td>
	...
	<script src="/Vertical/assets/js/index2.js"></script>
	<!-- App JS -->
