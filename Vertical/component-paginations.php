					...
					<div class="card radius-15">
						<div class="card-body">
							<div class="card-title">
								<h4 class="mb-0">Basic pagination</h4>
							</div>
							<hr/>
						...
						<div class="card-body">
							<div class="card-title">
								<h4 class="mb-0">Round pagination</h4>
							</div>
							<hr/>
							<nav aria-label="Page navigation example">
						...
						<div class="card-body">
							<div class="card-title">
								<h4 class="mb-0">Working with icons</h4>
							</div>
							<hr/>
							<nav aria-label="Page navigation example">
								<ul class="pagination">
									<li class="page-item">
										<a class="page-link" href="javascript:;" aria-label="Previous">	<span aria-hidden="true">&laquo;</span>
										</a>
									</li>
									...
									<li class="page-item">
										<a class="page-link" href="javascript:;" aria-label="Next">	<span aria-hidden="true">&raquo;</span>
										</a>
									</li>
								</ul>
							</nav>
						...
						<div class="card-body">
							<div class="card-title">
								<h4 class="mb-0">Disabled and active states</h4>
							</div>
							<hr/>
							<nav aria-label="...">
								<ul class="pagination">
									...
									<li class="page-item active" aria-current="page">	<a class="page-link" href="javascript:;">2 <span class="sr-only">(current)</span></a>
									</li>
									<li class="page-item"><a class="page-link" href="javascript:;">3</a>
									</li>
									<li class="page-item">	<a class="page-link" href="javascript:;">Next</a>
