									...
									<div class="col-12 col-lg-7 border-right">
										<div class="d-md-flex align-items-center">
											<div class="mb-md-0 mb-3">
												<img src="/Vertical/assets/images/avatars/avatar-1.png" class="rounded-circle shadow" width="130" height="130" alt="" />
											</div>
											<div class="ml-md-4 flex-grow-1">
												...
												<p class="mb-0">Sr. Web Developer</p>
												<p><i class='bx bx-buildings'></i> Epic Coders</p>
										...
										<div class="card shadow-none border mb-0 radius-15">
											<div class="card-body">
												<div class="d-sm-flex align-items-center mb-3">
													...
													<p class="mb-0 ml-sm-3">3 Job History</p> <a href="javascript:;" class="btn btn-light ml-auto radius-10"><i class='bx bx-plus'></i> Add More</a>
												</div>
												<div class="media"> <i class='bx bxl-dribbble media-icons bg-dribbble'></i>
													<div class="media-body ml-3">
														<div class="row align-items-center">
															...
															<div class="col-lg-4">
																<h5 class="mb-0"><i class='bx bx-time'></i> Feb-2017-Dec-2017</h5>
															</div>
															<div class="col-lg-4">
																<h5 class="mb-0"><i class='bx bxs-map'></i> New York, USA</h5>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-12 col-lg-3">
																<img src="/Vertical/assets/images/gallery/35.jpg" class="img-thumbnail" alt="">
															</div>
															<div class="col-12 col-lg-3">
																<img src="/Vertical/assets/images/gallery/36.jpg" class="img-thumbnail" alt="">
															</div>
															<div class="col-12 col-lg-3">
																<img src="/Vertical/assets/images/gallery/37.jpg" class="img-thumbnail" alt="">
															</div>
															<div class="col-12 col-lg-3">
																<img src="/Vertical/assets/images/gallery/38.jpg" class="img-thumbnail" alt="">
															</div>
														</div>
														<hr/>
													</div>
												...
												<div class="media"> <i class='bx bxs-diamond media-icons bg-warning'></i>
													<div class="media-body ml-3">
														<div class="row align-items-center">
															...
															<div class="col-lg-4">
																<h5 class="mb-0"><i class='bx bx-time'></i> Apr-2011-Sep-2013</h5>
															</div>
															<div class="col-lg-4">
																<h5 class="mb-0"><i class='bx bxs-map'></i> Sydney, Australia</h5>
															</div>
														</div>
																		...
																		<div class="card shadow-none border mb-3 mb-md-0">
																			<div class="card-body">
																				<div class="media align-items-center">
																					<img src="/Vertical/assets/images/icons/credit-card-visa.png" width="50" alt="">
																			...
																			<div class="card-footer text-right"> <a href="javascript:;" class="text-white">REMOVE</a>
																			</div>
																		</div>
																	</div>
																	<div class="col-12 col-lg-6">
																		<div class="card shadow-none border mb-0">
																			<div class="card-body">
																				<div class="media align-items-center">
																					<img src="/Vertical/assets/images/icons/mastercard-2.png" width="50" alt="">
																					<div class="media-body ml-2">
