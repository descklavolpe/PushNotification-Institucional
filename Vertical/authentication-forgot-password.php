			...
			<div class="card shadow-lg forgot-box">
				<div class="card-body p-md-5">
					<div class="text-center">
						<img src="/Vertical/assets/images/icons/forgot-2.png" width="140" alt="" />
					</div>
					...
					<button type="button" class="btn btn-light btn-lg btn-block radius-30">Send</button> <a href="authentication-login.html" class="btn btn-link btn-block"><i class='bx bx-arrow-back mr-1'></i>Back to Login</a>
				</div>
			</div>
		</div>
	</div>
