					...
					<div class="card radius-15">
						<div class="card-body">
							<div class="card-title">
								<h4 class="mb-0">Basic progress bars</h4>
							</div>
							<hr/>
						...
						<div class="card-body">
							<div class="card-title">
								<h4 class="mb-0">Multiple bars</h4>
							</div>
							<hr/>
							<div class="progress" style="height:7px;">
						...
						<div class="card-body">
							<div class="card-title">
								<h4 class="mb-0">Animated stripes</h4>
							</div>
							<hr/>
							<div class="progress" style="height:7px;">
