			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="row">
						...
						<div class="col-12 col-lg-4 col-xl-4">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/02.jpg" class="card-img-top" alt="...">
								<div class="card-body">
									<h5 class="card-title">Card title</h5>
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> <a href="#" class="btn btn-light">Go somewhere</a>
								</div>
						...
						<div class="col-12 col-lg-4 col-xl-4">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/03.jpg" class="card-img-top" alt="...">
								<div class="card-body">
									<h5 class="card-title">Card title</h5>
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> <a href="#" class="btn btn-light">Go somewhere</a>
								</div>
					...
					<div class="row">
						<div class="col-12 col-lg-4 col-xl-4">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/05.jpg" class="card-img-top" alt="...">
								<div class="card-body">
									<h5 class="card-title">Card title</h5>
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
								</div>
						...
						<div class="col-12 col-lg-4 col-xl-4">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/06.jpg" class="card-img-top" alt="...">
								<div class="card-body">
									<h5 class="card-title">Card title</h5>
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
								</div>
						...
						<div class="col-12 col-lg-4 col-xl-4">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/07.jpg" class="card-img-top" alt="...">
								<div class="card-body">
									<h5 class="card-title">Card title</h5>
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
								</div>
					...
					<div class="row">
						<div class="col-12 col-lg-3 col-xl-3">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/39.jpg" class="card-img-top" alt="...">
								<div class="card-body">
									<h5 class="card-title mb-0">Mark Rockwell</h5>
									<p class="mb-0">CEO - Consultant</p>
									<hr/>
									<div class="profile-social mt-3">	<a href="javascript:;" class=""><i class="bx bxl-facebook"></i></a>
										<a href="javascript:;" class=""><i class="bx bxl-twitter"></i></a>
										<a href="javascript:;" class=""><i class="bx bxl-google"></i></a>
										<a href="javascript:;" class=""><i class="bx bxl-linkedin"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="col-12 col-lg-3 col-xl-3">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/40.jpg" class="card-img-top" alt="...">
								<div class="card-body">
						...
						<div class="col-12 col-lg-3 col-xl-3">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/41.jpg" class="card-img-top" alt="...">
								<div class="card-body">
						...
						<div class="col-12 col-lg-3 col-xl-3">
							<div class="card">
								<img src="/Vertical/assets/images/gallery/42.jpg" class="card-img-top" alt="...">
								<div class="card-body">
					...
					<div class="row">
						<div class="col-12 col-lg-6 col-xl-6">
							<div class="card mb-3">
								<img src="/Vertical/assets/images/gallery/08.jpg" class="card-img-top" alt="...">
								<div class="card-body">
									<h5 class="card-title">Card title</h5>
									<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
									<p class="card-text"><small>Last updated 3 mins ago</small>
									</p>
								</div>
							</div>
						</div>
						<div class="col-12 col-lg-6 col-xl-6">
							<div class="card">
								...
								<img src="/Vertical/assets/images/gallery/09.jpg" class="card-img-top" alt="...">
							</div>
						</div>
					</div>
					<!--end row-->
						...
						<div class="col-12 col-lg-6 col-xl-6">
							<div class="card">
								<div class="row no-gutters">
									<div class="col-md-4">
										<img src="/Vertical/assets/images/gallery/10.jpg" class="card-img" alt="...">
									</div>
									<div class="col-md-8">
										<div class="card-body">
											<h5 class="card-title">Card title</h5>
						...
						<div class="col-12 col-lg-6 col-xl-6">
							<div class="card">
								<div class="row no-gutters">
									...
									<div class="col-md-4">
										<img src="/Vertical/assets/images/gallery/11.jpg" class="card-img" alt="...">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-12 col-lg-6 col-xl-6">
							<div class="card text-white">
								<img src="/Vertical/assets/images/gallery/12.jpg" class="card-img" alt="...">
						...
						<div class="col-12 col-lg-6 col-xl-6">
							<div class="card text-white">
								<img src="/Vertical/assets/images/gallery/13.jpg" class="card-img" alt="...">
								<div class="card-img-overlay">
									<h5 class="card-title">Card title</h5>
									<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
									<p class="card-text">Last updated 3 mins ago</p>
					...
					<div class="card-group">
						<div class="card">
							<img src="/Vertical/assets/images/gallery/14.jpg" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
								<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
								<p class="card-text"><small>Last updated 3 mins ago</small>
						...
						<div class="card">
							<img src="/Vertical/assets/images/gallery/15.jpg" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
						...
						<div class="card">
							<img src="/Vertical/assets/images/gallery/16.jpg" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
					...
					<div class="card-deck">
						<div class="card">
							<img src="/Vertical/assets/images/gallery/17.jpg" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
								<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
								<p class="card-text"><small>Last updated 3 mins ago</small>
						...
						<div class="card">
							<img src="/Vertical/assets/images/gallery/18.jpg" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
								<p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
								<p class="card-text"><small>Last updated 3 mins ago</small>
						...
						<div class="card">
							<img src="/Vertical/assets/images/gallery/19.jpg" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
								<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
								<p class="card-text"><small>Last updated 3 mins ago</small>
					...
					<div class="card text-center">
						...
						<div class="card-body">
							...
							<p class="card-text">With supporting text below as a natural lead-in to additional content.</p> <a href="#" class="btn btn-light">Go somewhere</a>
						</div>
					</div>
					<div class="card text-center">
						<div class="card-header">
					...
					<h6 class="mb-0 text-uppercase">Card Columns</h6>
					<hr>
					<div class="card-columns">
						<div class="card">
							<img src="/Vertical/assets/images/gallery/20.jpg" class="card-img-top" alt="...">
							<div class="card-body">
						...
						<div class="card">
							<img src="/Vertical/assets/images/gallery/21.jpg" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
								<p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
								<p class="card-text"><small>Last updated 3 mins ago</small>
						...
						<div class="card">
							<img src="/Vertical/assets/images/gallery/22.jpg" class="card-img-top" alt="...">
						</div>
