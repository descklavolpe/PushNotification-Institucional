...
<head>
	...
	<!-- HighCharts CSS-->
	<link href="/Vertical/assets/plugins/highcharts/css/highcharts-white.css" rel="stylesheet" />
	<!-- Bootstrap CSS -->
...
<body class="bg-theme bg-theme1">
	...
	<!-- highcharts js -->
	<script src="/Vertical/assets/plugins/highcharts/js/highcharts.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/highcharts-more.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/variable-pie.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/solid-gauge.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/highcharts-3d.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/cylinder.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/funnel3d.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/exporting.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/export-data.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/accessibility.js"></script>
	<script src="/Vertical/assets/plugins/highcharts/js/highcharts-custom.script.js"></script>
	<!-- App JS -->
