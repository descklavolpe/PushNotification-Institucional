	...
	<div class="wrapper">
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top border-bottom">
			<a class="navbar-brand" href="javascript:;">
				<img src="/Vertical/assets/images/logo-img.png" width="160" alt="">
			</a>
					...
					<div class="row no-gutters">
						<div class="col-lg-6">
							<div class="card-body">
								...
								<h2 class="font-weight-bold display-4 text-white">Lost in Space</h2>
								...
								<div class="mt-5">	<a href="javascript:;" class="btn btn-lg btn-light px-md-5 radius-30">Go Home</a>
									<a href="javascript:;" class="btn btn-lg btn-light ml-3 px-md-5 radius-30">Back</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<img src="/Vertical/assets/images/errors-images/404-error.png" class="card-img" alt="">
						</div>
					</div>
					<!--end row-->
				</div>
		...
		<div class="bg-light p-4 fixed-bottom border-top">
